...
type GradientPreset = "primary" | "success" | "warning" | "sunset" | "dark" | "custom";
...
export function GradientCard({
    ...
    const colors = (customColors || gradientPresets[gradient]) as [string, string, ...string[]];
        ...
        return (
            ...
            >
                <BlurView intensity={20} tint="dark" style={styles.blurView}>
                    <View style={[styles.glassOverlay, { borderColor: "rgba(255,255,255,0.15)" }]}>
                        <CardContent />
                    </View>
                </BlurView>
            </AnimatedPressable>
